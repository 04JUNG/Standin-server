"""Promoted runtime airborne plantar-plane transfer with exact V3.2.4 rollback.
...
V324_PATH = ROOT / "foot_plant.py"
V324_POLICY_PATH = ROOT / "foot_plant_policy.json"
...
def load_policy(path: str | os.PathLike[str] = POLICY_PATH) -> tuple[dict, str]:
    ...
    if policy.get("status") != "PROMOTED_RUNTIME":
        raise RuntimeError("V3.2.5 policy is not promoted")
    ...
    if force_exact_v324:
        with tempfile.TemporaryDirectory(prefix="v325-force-v324-") as temp_dir:
            ...
            selection = {
                ...
                "exact_parent_variant": "chain-transport-v3.2.4-foot-plant",
