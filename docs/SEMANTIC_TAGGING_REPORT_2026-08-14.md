...
> **2026-08-18 후속 갱신:** 활성 라이브러리는 원본 미러 짝 1개를 추가해 1,308 BVH / 654 semantic
> unit / orphan 0이 되었다. 행동명이 없던 CMU 35 source clip(38 unit)은 품질 사유로 PX 검색 제외 및
> 실제 삭제 대기 상태다. 따라서 아래 1,307·P0 1·P1 38 수치는 당시 배치 이력이다.
